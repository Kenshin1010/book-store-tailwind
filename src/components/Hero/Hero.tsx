...
const ImageList = [
  {
    ...
    description:
      'Lorem ipsum His Life will forever be Changed dolor sit amet consectetur adipisicing elit. Quas, sequi?',
  },
  {
    id: 2,
    img: Book2,
    title: "Who's there",
    description:
      "Who's there lorem ipsum His Life will forever be Changed dolor sit amet consectetur adipisicing elit. Quas, sequi?",
  },
  {
    id: 3,
    img: Book3,
    title: 'Lost Boy',
    description:
      'Lost Boy, lorem ipsum His Life will forever be Changed dolor sit amet consectetur adipisicing elit. Quas, sequi?',
  },
];

const Hero: React.FC<HandleOrderPopupProps> = ({ handleOrderPopup }) => {
      ...
      >
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2
            sm:order-1"
            >
              <h1
                data-aos="zoom-out"
              ...
              <div className="">
                ...
                to-secondary text-white px-4 py-2 rounded-md 
            ...
            >
              ...
              >
                {ImageList.map((data) => (
                  ...
                  inline-block hover:scale-110 duration-200 hover:cursor-pointer"
                    onClick={() => {
                      setImageId(
